...
import sys
sys.path.append(".")
from datasets.lmo_dataset import LMO_Test_Segmentation
...
img_size = (480, 640)
state_dict_path = 'eomt_seg/s48r8ccc/checkpoints/epoch=4-step=10000.ckpt'
...
lmo_config = data_config['LMO_Test_Dataset']
dataset = LMO_Test_Segmentation(lmo_config)
